...
void INT_DefaultInterruptHandler(void) {
    ...
    ADCval.adcResult1 = ADC_GetConversion(ANA);
    ADCval.adcResult_Sum = ADCval.adcResult_Sum + ADCval.adcResult1;
    ADCval.adccontSample++;
    if (ADCval.adccontSample >= numMuestasADC) {
        ADCval.adcResultTot = ADCval.adcResult_Sum / numMuestasADC;
        ADCval.adcResult_Sum = 0;
        ADCval.adccontSample = 0;
    }
}
